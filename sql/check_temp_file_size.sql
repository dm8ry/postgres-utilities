...
select datname,  pg_size_pretty(pg_database_size(datname)) db_size, temp_files, pg_size_pretty(temp_bytes) temp_size, stats_reset from pg_stat_database order by temp_bytes desc
